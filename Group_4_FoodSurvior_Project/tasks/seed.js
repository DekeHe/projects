...
async function main() {
    ...
    const user11 = await customersData.createUser("Muzzaffar", "Turak", "muzzaffar@gmail.com", "aaaaaa", "aaaaaa", "", "24");
    console.log(user11, "User 11 created successfully");
    
    const DreamZ = await restaurantsData.create("DreamZ Beauty Restaurant", "Washington Street Hoboken", "07030", [["Idli Sambar Dosa",3],["another dish",3]])
    // console.log(DreamZ, "DreamZ has been added successfully")

    const Telogen = await restaurantsData.create("Telogen Restaurant & Bar", "Washington Street Hoboken", "07030", [["Idli Sambar Dosa",3],["another dish",3]])
    // console.log(Telogen, "Telogen has been added successfully")

    const Roger = await restaurantsData.create("Roger Markel Restaurant", "Washington Street Hoboken", "07030", [["Idli Sambar Dosa",3],["another dish",3]])
    // console.log(Roger, "Roger has been added successfully")

    const Bloom = await restaurantsData.create("Bloom berk lounge", "Washington Street Hoboken", "07030", [["Idli Sambar Dosa",3],["another dish",3]])
    // console.log(Bloom, "Bloom has been added successfully")

    const Aerea = await restaurantsData.create("The Aerea Restaurant", "Washington Street Hoboken", "07030", [["Idli Sambar Dosa",3],["another dish",3]])
    // console.log(Aerea, "Aerea has been added successfully")

    const Madison = await restaurantsData.create("Madison Reed Restaurant", "Washington Street Hoboken", "07030", [["Idli Sambar Dosa",3],["another dish",3]])
    // console.log(Madison, "Madison has been added successfully")

    const Caru = await restaurantsData.create("The Restaurant Caru", "Washington Street Hoboken", "07030", [["Idli Sambar Dosa",3],["another dish",3]])
    // console.log(Caru, "Caru has been added successfully")

    const Phoenix = await restaurantsData.create("Restaurant Phoenix", "Washington Street Hoboken", "07030", [["Idli Sambar Dosa",3],["another dish",3]])
    // console.log(Phoenix, "Phoenix has been added successfully")

    const Hudson = await restaurantsData.create("Hudson Sqaure Restaurant", "Washington Street Hoboken", "07030", [["Idli Sambar Dosa",3],["another dish",3]])
    // console.log(Hudson, "Hudson has been added successfully")

    const Sole = await restaurantsData.create("Sole Restaurant", "Washington Street Hoboken", "07030", [["Idli Sambar Dosa",3],["another dish",3]])
    // console.log(Sole, "Sole has been added successfully")

    const UpOut = await restaurantsData.create("Up & Out Restaurant", "Washington Street Hoboken", "07030", [["Idli Sambar Dosa",3],["another dish",3]])
    // console.log(UpOut, "UpOut has been added successfully")

    const Sorella = await restaurantsData.create("Sorella Mia", "Washington Street Hoboken", "07030", [["Idli Sambar Dosa",3],["another dish",3]])
